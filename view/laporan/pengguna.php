...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="header">
                <h2><strong>Laporan</strong> Pengguna</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li><a href="index.php">Home</a>
                        </li>
                        <li class="active">Laporan Pengguna</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icon-doc"></i> <strong>Tipe</strong> Laporan Pengguna</h3>
                        </div>
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="index.php?menu=laporanPenggunaRole" class="btn btn-primary" style="width: 100%">Role</a>
                                    <a href="index.php?menu=laporanPenggunaStatus" class="btn btn-primary" style="width: 100%">Status</a>
                                </div>
                            </div>
                        </div>
                    </div>
