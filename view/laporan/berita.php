                        ...
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-primary" style="width: 100%">Filter By User</a>
                                    <a class="btn btn-primary" style="width: 100%">Filter By Tanggal</a>
                                    <a class="btn btn-primary" style="width: 100%">Semua</a>
                                </div>
                            </div>
                        </div>
                    </div>
