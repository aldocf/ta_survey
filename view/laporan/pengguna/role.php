...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="header">
                <h2>Laporan Penguna By<strong> Role</strong></h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li><a href="index.php">Home</a>
                        </li>
                        <li class="active">Laporan Pengguna By Role</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select class="form-control" name="role">
                                                    ...
                                                    <?php if (isset($_GET['id'])) {
                                                        if ($_GET['id'] == 0) {
                                                            ...
                                                            <option value="0" selected>Member
                                                            </option>
                                                            <?php
                                                        } else {
                                                            ?>
                                            ...
                                            <div class="col-md-12 m-b-10 m-t-10">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    if($_GET['id'] == 0){
                                                        ?>
                                                        <a href="./TCPDF-master/examples/laporanPengguna1.php"
                                                           target="_blank" class="btn btn-warning">Export PDF
                                                        </a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a href="./TCPDF-master/examples/laporanPengguna2.php"
                                                           target="_blank" class="btn btn-warning">Export PDF
                                                        </a>
                                                        <?php
                                                    }
