...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="header">
                <h2><strong>Update</strong> Berita</h2>
                ...
                <div class="col-md-8 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icon-doc"></i> <strong>Form</strong> Update Berita</h3>
                        </div>
                                            ...
                                            <div class="col-md-12 m-b-10">
                                                ...
                                                <select name="kategori" class="form-control form-white">
                                                    ...
                                                    while ($kategori->valid()) {
                                                        ...
                                                        if ($kategori->current()->getIdKategori() == $data->getKategori()) {
                                                            ?>
                                                            <option selected
                                                                    value="<?php echo $kategori->current()->getIdKategori(); ?>">
                                                                <?php echo $kategori->current()->getNamaKategori(); ?>
                                                            </option>
                                                            <?php
                                                        } else {
                                                            ?>
                                            ...
                                            <div class="col-md-12 m-b-10">
                                                ...
                                                <div class="adjoined-bottom">
                                                    <textarea class="summernote"
                                                              name="deskripsi"><?php echo $data->getDeskripsi() ?></textarea>
                                                </div>
                                            </div>
