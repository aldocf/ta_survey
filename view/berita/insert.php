...
<section>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="header">
                <h2><strong>Insert</strong> Berita</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li><a href="index.php">Home</a>
                        </li>
                        <li class="active">Insert Berita</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-8 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icon-doc"></i> <strong>Form</strong> Buat Berita</h3>
                        </div>
...
//                                                echo html_entity_decode("&lt;span style=&quot;font-weight: bold;&quot;&gt;SI ALDI SOMBONG&lt;/span&gt;");
                                            ...
                                            <div class="col-md-12 m-b-10 m-t-10">
                                                <button class="btn btn-primary" name="btnSubmit">Buat Berita
                                                </button>
                                            </div>
                                        </div>
                                    </div>
