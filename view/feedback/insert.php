                ...
                <div class="col-md-8 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icon-doc"></i> Masukan <strong>feedback</strong> jika ada kritik dan saran</h3>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="col-md-12 m-b-10">
                                                <textarea type="text" class="form-control form-white" name="feedback"
                                                          placeholder="Feedback" required rows="6"></textarea>
                                            </div>
                                            <div class="col-md-12 m-b-10 m-t-10">
                                                <button class="btn btn-primary" name="btnSubmit">Submit
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        <?php
        if ($msg == 1) {
            echo "makeAlert('success', 'Terima kasih!', 'Feedback anda akan kami proses.')";
        }
        ?>
    });
</script>
