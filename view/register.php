...
<!-- Mirrored from themes-lab.com/make/admin/layout4/user-signup-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Nov 2017 09:22:08 GMT -->
<!-- Added by HTTrack -->
...
<body class="sidebar-top account separate-inputs boxed" data-page="signup">
<!-- BEGIN LOGIN BOX -->
                ...
                <form class="form-signup" role="form" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="append-icon">
                                    <input type="text" name="nama" class="form-control form-white firstname" placeholder="Nama" required>
                                    <i class="icon-user"></i>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="append-icon  m-b-10">
                            <input type="number" name="telepon" class="form-control form-white icon-rounded-telephone" placeholder="Telephone" required>
                            <i class="icon-rounded-telephone"></i>
                        </div>
                        <div class="append-icon">
                        ...
                        <div class="append-icon m-b-20">
                            <input type="password" name="re-password" class="form-control form-white password2" placeholder="Repeat Password" required>
                            <i class="icon-lock"></i>
                        </div>
                        <button name="btnRegis" class="btn btn-lg btn-dark m-t-20" data-style="expand-left">Register
                        </button>
                        <div class="clearfix">
                            <p class="pull-left m-t-20"><a href="index.php">Back To Home</a></p>
                            <p class="pull-right m-t-20"><a href="index.php?menu=login">Already have an account? Sign
                                    In</a></p>
                        </div>
                    </div>
                </form>
...
<script>
    $(document).ready(function () {
        ...
        if ($msg == 1) {
            ...
            echo "makeAlert('success', 'Registrasi berhasil!', 'Silahkan verifikasi email anda.')";
...
<!-- Mirrored from themes-lab.com/make/admin/layout4/user-signup-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Nov 2017 09:22:09 GMT -->
</html>