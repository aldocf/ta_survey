    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel">
                        <a href="index.php?menu=insertKategoriBerita" class="btn btn-primary" style="margin: 20px;"><i
                                    class="icon-plus"></i> Insert Kategori Berita</a>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-hover table-dynamic">
                                ...
                                while ($data->valid()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?menu=updateKategoriBerita&id=<?php echo $data->current()->getIdKategori(); ?>"
